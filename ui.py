...
class QuizInterface():
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true_button = Button(image=self.check_image, highlightthickness=0, command=self.answer_is_true)
        self.true_button.grid(column=0, row=2)

        self.cross_image = PhotoImage(file="images/false.png")
        self.false_button = Button(image=self.cross_image, highlightthickness=0, command=self.answer_is_false)
